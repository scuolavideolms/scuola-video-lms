...
class Question {
  ...
  Question({this.id, this.title, this.type, this.descriptivecorrectanswer, this.grade, this.createdat, this.answers, this.updatedat, this.image});
...
class Quiz {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['image'] = questions != null ? questions!.map((v) => v.toJson()).toList() : null;
