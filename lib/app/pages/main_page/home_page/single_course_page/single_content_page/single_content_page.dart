...
class _SingleContentPageState extends State<SingleContentPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      // Ensure that you are getting the arguments from the route
      ...
      // Using Future.wait to wait for multiple asynchronous calls
      Future.wait([getData(), getPreviousData(), getNote()]).then((value) {
        // Ensuring that any UI updates or state changes happen on the main thread
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          // Update the state safely on the main thread
          setState(() {
            isLoading = false;
          });
        });
