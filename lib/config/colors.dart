...
Color green77() => const Color(0xff5A4AE3);
Color secondary() => const Color(0xffFF8C08);


Color green91() => const Color(0xff5A4AE3);
Color blue64() => const Color(0xff5A4AE3);
...
LinearGradient drawerbackGradint() => LinearGradient(
    colors: [
      Color(0xff3E2DB4),
      Color(0xff3E2DB4),
    ],
...
Color green63 = const Color(0xff5A4AE3);
...
// Semantics
Color green50 = const Color(0xff5A4AE3);
Color green4B = const Color(0xff5A4AE3);
Color green9D = const Color(0xff5A4AE3);
