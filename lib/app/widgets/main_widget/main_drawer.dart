...
class _MainDrawerState extends State<MainDrawer> {
  ...
  var name = AppData.getAccessToken();
  @override
  void initState() {
    super.initState();
  ...
  Future<void> logout() async {
    ...
    // final FirebaseAuth auth = FirebaseAuth.instance; // Uncomment if needed
    ...
    try {
      ...
      // Sign out from Firebase (optional, if using)
      // await auth.signOut();

      // Clear your app-specific data
      await AppData.saveAccessToken('');
      await AppDataBase.clearBox();
                    ...
                    Expanded(
                      ...
                      child: Column(
                        children: [
                          ...
                          menuItem(appText.deleteAccount, AppAssets.deleteSvg, () async {
                            if (hasAccess(canRedirect: true)) {
                              await launchUrlString(
                                "https://scuolavideo.com/delete_account_request/${token}" ?? '',
