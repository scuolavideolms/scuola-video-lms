              ...
              child: Column(
                ...
                : SingleChildScrollView(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        (quizData?.questions?[currentQuestionIndex].image?.isNotEmpty ?? false)
                        ?
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Center(
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(18), // Apply border radius
                              child: Container(
                                ...
                                child: Image.network(
                                  "https://scuolavideo.com${quizData?.questions?[currentQuestionIndex].image}",
