...
import 'package:webinar/app/pages/main_page/home_page/quizzes_page/quizes2.dart';
...
import 'app/pages/main_page/home_page/home_page.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          WebViewPage.pageName: (context) =>  WebViewPage(),
          ...
          QuizzesPage.pageName: (context) =>  QuizzesPage(),
          QuizzesPage2.pageName: (context) =>  QuizzesPage2(),
