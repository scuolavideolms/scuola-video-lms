...
class QuizzesPage2 extends StatefulWidget {
  static const String pageName = '/quizes2';

 const  QuizzesPage2({super.key});

  @override
  State<QuizzesPage2> createState() => _QuizzesPageState();
}

class _QuizzesPageState extends State<QuizzesPage2> with TickerProviderStateMixin
{
